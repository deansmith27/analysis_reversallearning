function plotBehaviorLapAndSession_DC(anindex,an,dirs,params,plotByDateOrType,plotDate,whichDay,sessionToPlot,doSessionPlots,doLapPlots,plotLapByBlock,numTrPerBlock, whichBlocks)
...
for i = 1:size(anindex,1)
    ...
    f1 = fullfile(dirs.loadoutputstructs, '\Data\Behavior\sessionData\', [params.iden num2str(sessionInfo(1), '%01d')], ...
        [num2str(sessionInfo(2)) '_' num2str(sessionInfo(3)) '_' num2str(sessionInfo(4))], 'statsByLap.mat');
    f2 = fullfile(dirs.loadoutputstructs, '\Data\Behavior\sessionData\', [params.iden num2str(sessionInfo(1), '%01d')], ...
